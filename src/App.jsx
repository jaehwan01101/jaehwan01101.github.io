...
const experience = [
  ...
  },
  {
    ...
    description: [
      ...
      "소프트웨어 복수전공에서는 프로그래밍기초를 바탕으로 C·Java·Python을 학습하고, 자료구조 및 실습·객체지향프로그래밍·웹 프로그래밍·모바일 웹 프로그래밍·모바일프로그래밍·로봇공학 과목을 통해 소프트웨어 구현 경험을 넓혔습니다. 단기·장기 현장실습을 병행하며 학습 내용을 실제 업무 환경에 연결했고, 이를 바탕으로 클라우드·인프라 역량을 확장하고 있습니다.",
    ],
    tags: [
      "C", "Java", "Python", "JavaScript", "HTML", "자료구조", "객체지향",
